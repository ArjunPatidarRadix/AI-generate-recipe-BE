...
authRouter.post("/signup", [
    ...
    (0, express_validator_1.body)("password", "Please enter a password with min length to 5").isLength({
        min: 5,
    }),
...
], auth_controller_1.postSignup);
authRouter.post("/logout", isAuth_1.isAuth, auth_controller_1.postLogout);
authRouter.get("/myProfile", isAuth_1.isAuth, auth_controller_1.getProfile);
